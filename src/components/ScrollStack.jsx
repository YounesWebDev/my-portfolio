...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const responsiveStackPosition = isMobile ? '28%' : stackPosition
    const responsiveScaleEndPosition = isMobile ? '28%' : scaleEndPosition

    const stackPositionPx = parsePercentage(responsiveStackPosition, containerHeight)
    const scaleEndPositionPx = parsePercentage(responsiveScaleEndPosition, containerHeight)
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      const pinEnd =
        endElementTop -
        containerHeight / 2 -
        (cardsRef.current.length - 1 - i) * itemStackDistance
  ...
  }, [itemDistance, measureLayout, setupLenis, updateCardTransforms])
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner pt-[16vh] sm:pt-[20vh] px-0 sm:px-6 lg:px-20 pb-[32rem] sm:pb-[50rem] min-h-screen">
        {children}
